package com.suchness.realscene.common.utils.poi;
...
import com.suchness.realscene.common.utils.ReflectUtils;
...
import static com.suchness.realscene.common.utils.DateUtils.dateTimeNow;
...
public class ExcelUtil<T>
{
   ...
   /**
     ...
     * @return 结果
     */
    public Object exportExcel(List<T> list, String sheetName)
    {
     ...
     * @return 结果
     */
    public Object importTemplateExcel(String sheetName)
    {
    ...
    {
        String downloadPath = Constants.DOWNLOAD_PATH +File.separator+ filename;
    ...
    {
        filename = dateTimeNow() + "_" + filename + ".xlsx";
        return filename;
    }
